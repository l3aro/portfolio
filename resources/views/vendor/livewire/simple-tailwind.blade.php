@php
    ...
    if (! isset($scrollIntoViewOptions)) {
        $scrollIntoViewOptions = true;
    }

    $scrollIntoViewOptions = json_encode($scrollIntoViewOptions);

    $scrollIntoViewJsSnippet =
        $scrollTo !== false
            ? <<<JS
            (\$el.closest('{$scrollTo}') || document.querySelector('{$scrollTo}')).scrollIntoView($scrollIntoViewOptions)
            JS
            : '';
@endphp
