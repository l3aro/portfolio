...
return [
    ...
    */
    'commands' => [
        'Vite' => env('VITE_PACKAGE_MANAGER', 'pnpm') . ' run dev --port=' . env('VITE_PORT', 5173),
        'Make' => new MakeCommand(),
        // 'HTTP' => 'php artisan serve',

        // Lazy commands do not automatically start when Solo starts.
        'Pint' => Command::from('./vendor/bin/pint --ansi')->lazy(),
        'Prettier' => Command::from(env('VITE_PACKAGE_MANAGER', 'pnpm') . ' prettier ./resources/css/ ./resources/js/ ./resources/views/ --write')->lazy(),
